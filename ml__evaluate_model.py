# code based on https://github.com/srigas/MTAD-GAT-mlflow/blob/main/evaluate.py
...
from mtad_gat.utils import get_run_id, get_data, SlidingWindowDataset, create_data_loader
from mtad_gat.utils import pot_threshold, json_to_numpy, update_json
from mtad_gat.utils import get_metrics, PA, calculate_latency
...
if __name__ == "__main__":
    ...
    parser.add_argument("--include_details", action='store_true')
    ...
    parser.add_argument("--dynamic_pot", action='store_true')
    ...
    with mlflow.start_run(run_id=run_id):
        ...
        # Load the model
        model = mlflow.pytorch.load_model(f"runs:/{run_id}/{dataset}_model")
        ...
        new_scores, df = handler.score(loader=eval_loader, details=args.include_details)
